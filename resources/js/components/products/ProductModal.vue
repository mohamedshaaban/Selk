              ...
              <div class="col-sm-8">
                ...
                <div v-if="product.offer">
                  <p class="old-price">
                    ...
                    >{{ (product.price * this.product.currency_exchange_rate).toFixed(3) }}</span>
                  </p>
                  <p class="price">
                    {{ this.product.currncy_name }}
                    <span
                ...
                <div v-if="product.options">
                  <div class="row size-qty" v-for="option in product.options" :key="option.key">
                    ...
                    <div v-for="option_value in product.option_values" :key="option_value.key">
                ...
                <div v-if="error">
                  <span
                    class="error"
                    v-for="errorMessage in errorsMessages"
                ...
                <div class="row size-qty" v-if="!disabledQuantity">
                  <div class="col-xs-6 col-md-5" v-if="product.maxima_order>0">
